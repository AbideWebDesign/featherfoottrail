...
<div class="bg-primary p-4 text-white mt-4">
	<div class="mp_wrapper mp_login_form">
	  ...
	  <?php else: ?>
	    ...
	    <form name="mepr_loginform" id="mepr_loginform" class="mepr-form" action="<?php echo $login_url; ?>" method="post">
	      ...
	      <div class="submit">
	        <input type="submit" name="wp-submit" id="wp-submit" class="btn btn-white btn-lg" value="<?php _ex('Log In', 'ui', 'memberpress'); ?>" />
	    ...
	    <div class="mepr-login-actions">
	      <a href="<?php echo $forgot_password_url; ?>" class="text-white"><?php _ex('Forgot Password', 'ui', 'memberpress'); ?></a>
	    </div>
