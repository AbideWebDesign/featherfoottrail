...
<div class="mp_wrapper">
  <div id="mepr-account-nav" class="d-flex">
    <div class="d-flex mepr-nav-item <?php MeprAccountHelper::active_nav('home'); ?>">
    ...
    <div class="d-flex mepr-nav-item"><a href="<?php echo MeprUtils::logout_url(); ?>" id="mepr-account-logout"><?php _ex('Logout', 'ui', 'memberpress'); ?></a></div>
  </div>
</div>
